...
int main()
{
    ...
    // Aqui se imprime fila por fila la primera parte del patron correspondiente al numero ingresado.
    ...
    // Aqui se imprime fila por fila la segunda parte del patron correspondiente al numero ingresado.
    for(int row=size-1; row>0; --row){
        ...
        // Este ciclo se encarga de imprimir los espacios de una fila.
        for(int aux=0; aux<(size-row)*2-1; ++aux){
            cout << " ";
        }
        // Este ciclo se encarga de imprimir el segundo conjunto de letras de una fila.
        for(int aux=0; aux<row; ++aux){
